...
.header-nav-bar li:first-child span{
    color: #8854c0;
}
...
.container-course:nth-child(1){
    margin-left:0px;
}

.container-course:nth-child(n+6){
    display:none;
}
    ...
    <div class="slide-show">
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                @if($slide_shows->first())
                    @foreach($slide_shows as $slide_show)
                        @if($slide_show->id == 1)
                            <div class="carousel-item active">
                                <img src="{!!$slide_show->slide_show_image!!}" class="d-block w-100">
                            </div>
                        @else
        ...
        @foreach($topics as $topic)
            <div class="content">
                <div class="topic-name">
                    ...
                    <a class="btn" href="{{route('guest.topic' , $topic->id)}}" role="button">Xem thêm</a>
                </div>

                <div class="course">
                    @foreach($courses as $course)
                        @if($course->topic_id == $topic->id && $course->course_share == 1)
