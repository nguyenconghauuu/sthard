...
.header-nav-bar li:nth-child(4){
    border-bottom: 3px solid #8854c0;
}

.header-nav-bar li:nth-child(4) span{
    color: #8854c0;
}
...
<body>
    ...
    <div class="content" style="margin-top:80px">
        ...
        <div class="course">
            @if($course_activitys->first())
                @foreach($courses as $course)
                    @foreach($course_activitys as $course_activity)
                        @if($course->id == $course_activity->course_id)
            ...
            @else
                <div class="message">
                    <span>Tiếc quá bạn chưa tham gia một khóa học nào...</span>
                </div>
            @endif
        </div>
    </div>
    <div class="content">
        ...
        <div class="quiz">
            @if($exam_activitys->first())
                @foreach($exams as $exam)
                    @foreach($exam_activitys as $exam_activity)
                        @if($exam->id == $exam_activity->exam_id)
            ...
            @else
                <div class="message">
                    <span>Tiếc quá bạn chưa tham gia một đề thi nào...</span>
                </div>
            @endif
        </div>
    </div>
