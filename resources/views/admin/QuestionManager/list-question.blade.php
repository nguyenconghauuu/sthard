                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th style="width:15%">Tên đề thi</th>
                                <th style="width:72%">Nội dung - Đáp án câu hỏi</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <li><b>Câu hỏi - {!!$question->question_content!!}</b></li>
                                        <li>Đáp án A - {!!$question->answer_a!!}</li>
                                        <li>Đáp án B - {!!$question->answer_b!!}</li>
                                        <li>Đáp án C - {!!$question->answer_c!!}</li>
                                        <li>Đáp án D - {!!$question->answer_d!!}</li>
                                        <li>
                                            <b>Đáp án đúng
                                                @if($question->result == 1)
                                                    A
                                                @elseif($question->result == 2)
                                                    B
                                ...
                                <td>
                                    <div class="table-group-icon">
                                        <div class="group-icon">
                                            <a href="{{route('admin.show-question' , $question->id)}}"><i style="font-size:14px" class="fa-solid fa-pen-to-square"></i></a>
                                        </div>
                                        <div class="group-icon">
                                            <a href="{{route('admin.destroy-question' , $question->id)}}"><i class="fa-solid fa-trash-can"></i></a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
