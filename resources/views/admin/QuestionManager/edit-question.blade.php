                    ...
                    <div class="form-group-container">
                        ...
                        <div class="form-group">
                            ...
                            @if($questions->question_level == 1)
                                <input style="background-color:#e8f0fe" class="form-control" type="button" name="exam_name" value="Dễ">
                            @elseif($questions->question_level == 2)
                                <input style="background-color:#e8f0fe" class="form-control" type="button" name="exam_name" value="Trung bình">
                            @else
                                <input style="background-color:#e8f0fe" class="form-control" type="button" name="exam_name" value="Khó">
                            @endif
                        </div>
                        ...
                        <div class="form-group" style="width:100%">
                            ...
                            @if($questions->result == 1){
                                    <option value="1" style="background-color:#1cc88a;color:#fff">Đáp án A</option>
                                ...
                                @if($questions->result == 2){
                                    <option value="2" style="background-color:#1cc88a;color:#fff">Đáp án B</option>
                                ...
                                @if($questions->result == 3){
                                    <option value="3" style="background-color:#1cc88a;color:#fff">Đáp án C</option>
                                    <option value="1">Đáp án A</option>
                                    <option value="2">Đáp án B</option>
                                    <option value="4">Đáp án D</option>
                                }
                                ...
                                @if($questions->result == 4){
                                    <option value="4" style="background-color:#1cc88a;color:#fff">Đáp án D</option>
                                    <option value="1">Đáp án A</option>
                                    <option value="2">Đáp án B</option>
                                    <option value="3">Đáp án C</option>
                                }
