        ...
        <div class="content">
            ...
            <div class="homepage-container">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th style="width:70%">Ảnh trình chiếu</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{!! $stt++ !!}</td>
                                <td><img style="width:800px;height:200px" src="{!!$slide_show->slide_show_image!!}"></td>
                                <td>{!! $slide_show->created_at->format('d-m-Y') !!}</td>
                                <td>
                                    <div class="table-group-icon">
                                        <div class="group-icon">
                                            <a href="{{route('admin.edit-slideshow' , $slide_show->id)}}"><i style="font-size:14px" class="fa-solid fa-pen-to-square"></i></a>
                                        </div>
                                        <div class="group-icon">
                                            <a href="{{route('admin.destroy-slideshow' , $slide_show->id)}}"><i class="fa-solid fa-trash-can"></i></a>
                                        </div>
                                        <div class="group-icon">
                ...
                <div class="pagination" style="float:right;margin-right:2%">
                    {!! $slide_shows->appends(request()->all())->links('pagination::bootstrap-4') !!}
                </div>
            </div>
