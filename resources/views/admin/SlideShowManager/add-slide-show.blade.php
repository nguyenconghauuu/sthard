            ...
            <div class="homepage-container">
                <div class="form-group-top-bar">
                    ...
                    @elseif(Session::has('error'))
                        <span style="color:#e81500">{{Session::get('error')}}</span>
                    @else
                ...
                <form action="{{route('admin.store-slideshow')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-button">
                        <a href="{{route('admin.create-slideshow')}}"><button style="margin-right:10px" type="button" class="btn btn-secondary">Làm mới</button></a>
                        <button type="submit" class="btn btn-primary">Thêm ảnh trình chiếu</button>
                    </div>
                </form>
            </div>
        </div>
