                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th style="width:5.5%">Lớp</th>
                                <th style="width:23%">Tên khóa học</th>
                                <th style="width:38%">Tiêu đề</th>
                                <th style="width:10%">Chia sẻ</th>
                                <th style="width:10.5%">Ngày Tạo</th>
                                ...
                                <td>
                                    <div class="table-group-icon">
                                        <div class="group-icon">
                                            <a href="{{route('admin.edit-course' , $course->id)}}"><i style="font-size:14px" class="fa-solid fa-pen-to-square"></i></a>
                                        </div>
                                        <div class="group-icon">
                                            <a onclick="DestroyCourse('{{$course->id}}')"><i class="fa-solid fa-trash-can"></i></a>
                                            <div class="notification" id="course-{{$course->id}}">
                                                <div class="actived">
                                                    <form action="{{route('admin.destroy-course' , $course->id)}}" method="get">
                                                        @csrf
                                                        <div class="actived-text">
                                                            <span>Bạn có chắc muốn xóa khóa học này không? Mọi dữ liệu liên quan đến khóa học này sẽ bị xóa khỏi hệ thống.</span>
                                                        </div>
                                                        <div class="actived-button">
                                                            <button type="submit">Đồng ý</button>
                                                            <span class="btn-destroy-close" onclick="Cancel('{{$course->id}}')">Hủy</span>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                        ...
                                        <div class="group-icon">
                                            <a href="{{route('guest.index')}}"><i class="fa-solid fa-display"></i></a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
...
<script type="text/javascript">
    function DestroyCourse(value){
        let id = 'course-'.concat(value);
