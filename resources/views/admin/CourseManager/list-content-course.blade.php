                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th style="width:18%">Tên khóa học</th>
                                ...
                                <td>
                                    <div class="table-group-icon">
                                        <div class="group-icon">
                                            <a href="{{route('admin.content-course' , $course->id)}}"><i style="font-size:14px" class="fa-solid fa-plus"></i></a>
                                        </div>
                                        <div class="group-icon">
                                            <a href="{{route('user.course-content' , $course->id)}}"><i class="fa-solid fa-display"></i></a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
