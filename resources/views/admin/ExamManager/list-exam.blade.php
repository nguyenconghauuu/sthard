                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th style="width:23%">Tên đề thi</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{!! $exam->exam_time !!} phút</td>
                                <td>{!! $exam->created_at->format('d-m-Y') !!}</td>
                                <td>
                                    <div class="table-group-icon">
                                        <div class="group-icon">
                                            <a href="{{route('admin.show-exam' , $exam->id)}}"><i style="font-size:14px" class="fa-solid fa-pen-to-square"></i></a>
                                        </div>
                                        <div class="group-icon">
                                            <a onclick="DestroyExam('{{$exam->id}}')"><i class="fa-solid fa-trash-can"></i></a>
                                            <div class="notification" id="exam-{{$exam->id}}">
                                                <div class="actived">
                                                    <form action="{{route('admin.destroy-exam' , $exam->id)}}" method="get">
                                                        @csrf
                                                        <div class="actived-text">
                                                            <span>Bạn có chắc muốn xóa đề thi này không? Mọi dữ liệu liên quan đến đề thi này sẽ bị xóa khỏi hệ thống.</span>
                                                        </div>
                                                        <div class="actived-button">
                                                            <button type="submit">Đồng ý</button>
                                                            <span class="btn-destroy-close" onclick="Cancel('{{$exam->id}}')">Hủy</span>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                        ...
                                        <div class="group-icon">
                                            <a href="{{route('user.quiz')}}"><i class="fa-solid fa-display"></i></a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
...
<script type="text/javascript">
    function DestroyExam(value){
        let id = 'exam-'.concat(value);
