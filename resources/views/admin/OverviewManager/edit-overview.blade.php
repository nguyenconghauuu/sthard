    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="homepage-container">
                ...
                <form action="{{route('admin.update-overview-content-course' , $course_overview_contents->id)}}" method="post">
                    @csrf
                    <div class="form-group-container">
                        <div class="form-group" style="width:100%;height:auto">
                            <label for="form-label">Tổng quan</label>
                            <textarea style="max-width:100%" type="text" class="form-control my-editor" name="overview_content">{!! $course_overview_contents->overview_content !!}</textarea>
