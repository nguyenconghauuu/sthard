        ...
        <div class="content">
            ...
            <div class="homepage-container">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th style="width:52%">Tổng quan</th>
                                <th style="width:10%">Thao tác</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($course_overview_contents as $course_overview_content)
                            <tr>
                                <td>{!! $stt++ !!}</td>
                                <td>{!! $course_overview_content->course_name !!}</td>
                                <td>{!! $course_overview_content->created_at->format('d-m-Y') !!}</td>
                                <td>{!! $course_overview_content->overview_content !!}</td>
                                <td>
                                    <div class="table-group-icon">
                                        <div class="group-icon">
                                            <a href="{{route('admin.show-overview-content-course' , $course_overview_content->id)}}"><i style="font-size:14px" class="fa-solid fa-pen-to-square"></i></a>
                                        </div>
                                        <div class="group-icon">
                                            <a href="{{route('admin.destroy-overview-content-course' , $course_overview_content->id)}}"><i class="fa-solid fa-trash-can"></i></a>
                                        </div>
                                        <div class="group-icon">
                                            <a href="{{route('user.course-content' , $course_overview_content->course_id)}}"><i class="fa-solid fa-display"></i></a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                ...
                <div class="pagination" style="float:right;margin-right:2%">
                    {!! $course_overview_contents->appends(request()->all())->links('pagination::bootstrap-4') !!}
                </div>
            </div>
        </div>
    </div>
