        ...
        <div class="content">
            ...
            <div class="homepage-container">
                                    ...
                                    <td>
                                        <div class="table-group-icon">
                                            <div class="group-icon">
                                                <a href="{{route('admin.edit-topic' , $topic->id)}}"><i style="font-size:14px" class="fa-solid fa-pen-to-square"></i></a>
                                            </div>
                                            <div class="group-icon">
                                                <a onclick="DestroyTopic('{{$topic->id}}')"><i class="fa-solid fa-trash-can"></i></a>
                                                <div class="notification" id="topic-{{$topic->id}}">
                                                    <div class="actived">
                                                        <form action="{{route('admin.destroy-topic' , $topic->id)}}" method="get">
                                                            @csrf
                                                            <div class="actived-text">
                                                                <span>Bạn có chắc muốn xóa chủ đề này không? Mọi dữ liệu liên quan đến chủ đề này sẽ bị xóa khỏi hệ thống.</span>
                                                            </div>
                                                            <div class="actived-button">
                                                                <button type="submit">Đồng ý</button>
                                                                <span class="btn-destroy-close" onclick="Cancel('{{$topic->id}}')">Hủy</span>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                ...
                <div class="pagination" style="float:right;margin-right:2%">
                    {!! $topics->appends(request()->all())->links('pagination::bootstrap-4') !!}
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    function DestroyTopic(value){
        let id = 'topic-'.concat(value);
