    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="homepage-container">
                ...
                <form action="{{route('admin.update-topic' , $topic->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group-container">
                        <div class="form-group">
                            <label for="form-label">Tên chủ đề</label>
                            <input class="form-control" type="text" name="topic_name" value="{!!$topic->topic_name!!}">
