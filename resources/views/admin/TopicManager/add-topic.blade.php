    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="homepage-container">
                ...
                <form action="{{route('admin.store-topic')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group-container">
                        <div class="form-group">
                            <label for="form-label">Tên chủ đề</label>
                            <input class="form-control" type="text" placeholder="Enter..." name="topic_name" value="{{old('topic_name')}}">
                    ...
                    <div class="form-button">
                        <a href="{{route('admin.create-topic')}}"><button style="margin-right:10px" type="button" class="btn btn-secondary">Làm mới</button></a>
