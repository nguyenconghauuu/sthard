    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="homepage-container">
                ...
                <form action="{{route('admin.update-file-content-course' , $course_file_contents->id)}}" method="post"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="form-group-container">
                        <div class="form-group">
                            <label for="form-label">Nội dung</label>
                            <input style="background-color:#e8f0fe" class="form-control" type="button" name="file_content" value="{!!$course_file_contents->file_content!!}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group">
                                    ...
                                    <input id="thumbnail" class="form-control" type="text" name="filepath" value="{!! $course_file_contents->link !!}">
                                </div>
                                <img id="holder">
...
<script type="text/javascript">
    $('#lfm').filemanager('video', 'application');
</script>
