    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="homepage-container">
                ...
                <form action="{{route('admin.update-index-course' , $course_index_contents->id)}}" method="post">
                    @csrf
                    <div class="form-group-container">
                        <div class="form-group" style="width:100%">
                            <label for="form-label">Nội dung mục lục</label>
                            <input class="form-control" type="text" name="index_content" value="{!!$course_index_contents->index_content!!}">
