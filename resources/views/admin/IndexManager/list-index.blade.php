                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th style="width:65%">Bạn sẽ học được gì</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($course->CourseIndex != NULL)
                                    @foreach($course->CourseIndexContent as $course_index_contents)
                                    <ul>
                                        <li>{!! $course_index_contents->index_content !!}
                                            <div class="table-group-icon">
                                                <div class="group-icon">
                                                    <a href="{{route('admin.show-index-course' , $course_index_contents->id)}}"><i style="font-size:14px" class="fa-solid fa-pen-to-square"></i></a>
                                                </div>
                                                <div class="group-icon">
                                                    <a href="{{route('admin.destroy-index-course' , $course_index_contents->id)}}"><i class="fa-solid fa-trash-can"></i></a>
                                                </div>
                                                <div class="group-icon">
                                                    <a href="{{route('user.course-content' , $course_index_contents->course_id)}}"><i class="fa-solid fa-display"></i></a>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
