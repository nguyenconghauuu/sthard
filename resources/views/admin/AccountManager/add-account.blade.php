            ...
            <div class="homepage-container">
                ...
                <form action="{{route('admin.store-account')}}" method="post">
                    ...
                    <div class="form-group-container">
                        ...
                        <div class="form-group">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Enter..." name="fullname" value="{{old('fullname')}}">
                                <div class="alert-error">
                                    @error('fullname')
                                        <span>{!!$message!!}</span>
                                    @enderror
                        ...
                        <div class="form-group">
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" placeholder="Enter..." name="passcode" value="{{old('passcode')}}">
                                <div class="alert-error">
                                    @error('passcode')
                                        <span>{!!$message!!}</span>
                                    @enderror
                        ...
                        <div class="form-group">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" placeholder="Enter..." name="user_code" value="{{old('user_code')}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="level">
                                ...
                                @if(old('level') == 2)
                                    <option style="background-color:#1cc88a;color:#fff" value="2">Thành viên</option>
                                    <option value="1">Quản trị viên</option>
                                @endif

                                @if(old('level') == 1)
                                    <option style="background-color:#1cc88a;color:#fff" value="1">Quản trị viên</option>
                                    <option value="2">Thành viên</option>
                                @endif
                            </select>
                        </div>
                    ...
                    <div class="form-button">
                        <a href="{{route('admin.create-account')}}"><button style="margin-right:10px" type="button" class="btn btn-secondary">Làm mới</button></a>
