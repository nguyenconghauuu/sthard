    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="homepage-container">
                ...
                <form action="{{route('admin.update-account' , $user->id)}}" method="post">
                    @csrf
                    <div class="form-group-container">
                        ...
                        <div class="form-group">
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" name="passcode" value="{!!$user->password!!}">
                                <div class="alert-error">
                                    @error('passcode')
                                        <span>{!!$message!!}</span>
                                    @enderror
                        ...
                        <div class="form-group">
                            <div class="mb-3">
                                ...
                                <input style="background-color:#e8f0fe" type="button" class="form-control" name="class_code" value="{!!($user->class_code) ? $user->class_code : 'Chưa đăng ký'!!}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="mb-3">
                                ...
                                <input style="background-color:#e8f0fe" type="button" class="form-control" name="email" value="{!!$user->email!!}">
                                <div class="alert-error">
                                    @error('email')
                                        <span>{!!$message!!}</span>
                                    @enderror
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="level">
                                @if($user->level == 2){
                                    <option value="2" style="background-color:#1cc88a;color:#fff">Thành Viên</option>
                                    <option value="1">Quản trị viên</option>
                                }
                                @endif

                                @if($user->level == 1){
                                    <option value="1" style="background-color:#1cc88a;color:#fff">Quản Trị Viên</option>
