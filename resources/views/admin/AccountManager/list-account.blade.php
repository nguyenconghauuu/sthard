                                ...
                                <td>
                                    <div class="table-group-icon">
                                        <div class="group-icon">
                                            <a href="{{route('admin.edit-account' , $user->id)}}"><i style="font-size:14px" class="fa-solid fa-pen-to-square"></i></a>
                                        </div>
                                        <div class="group-icon">
                                            <a onclick="DestroyAccount('{{$user->id}}')"><i class="fa-solid fa-trash-can"></i></a>
                                            <div class="notification" id="user-{{$user->id}}">
                                                <div class="actived">
                                                    <form action="{{route('admin.destroy-account' , $user->id)}}" method="get">
                                                        @csrf
                                                        <div class="actived-text">
                                                            <span>Bạn có chắc muốn xóa tài khoản này không? Mọi dữ liệu liên quan đến tài khoản này sẽ bị xóa khỏi hệ thống.</span>
                                                        </div>
                                                        <div class="actived-button">
                                                            <button type="submit">Đồng ý</button>
                                                            <span class="btn-destroy-close" onclick="Cancel('{{$user->id}}')">Hủy</span>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    function DestroyAccount(value){
        let id = 'user-'.concat(value);
